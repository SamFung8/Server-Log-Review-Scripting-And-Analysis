...
ipList = ["10.24.41.41", "10.24.41.42", "10.22.255.61", "10.22.255.62"]
hostNameFiles = ["vpn1lf3c", "vpn1lf4d", "vpn1lc3a", "vpn1lc4b"]
...
for r, d, f in os.walk(path):
    for file in f:    
        if '.log' in file:
            for hostNameFile in hostNameFiles:
                for date in dateList:
                    if hostNameFile in file and date in file:
...
content = content + "\nChecked Hostname: " + str(hostNameFiles)
